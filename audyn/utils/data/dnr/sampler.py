...
class RandomStemsDNRSampler(Sampler):
    ...
    .. code-block::
        ...
        >>> import torch
        >>> from audyn.utils.data.dnr.sampler import RandomStemsDNRSampler
        >>> torch.manual_seed(0)
        >>> track_names = [
        ...
        ... ]
        >>> sampler = RandomStemsDNRSampler(track_names)
...
class _ReplacementRandomStemsSampler(RandomSampler):
    """Core implementation of RandomStemsDNRSampler with replacement.
