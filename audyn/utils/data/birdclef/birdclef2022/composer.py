...
from . import primary_labels as birdclef2022_primary_labels
...
class BirdCLEF2022PrimaryLabelComposer(BirdCLEFPrimaryLabelComposer):
    """Composer to include primary label of BirdCLEF2022.
