...
class BirdCLEF2022PrimaryLabelDataset(BirdCLEFPrimaryLabelDataset):
    """Dataset for training of bird classification model in BirdCLEF2022.

    Args:
        list_path (str): Path to list file. Each entry represents path to audio file
            without extension such as ``afrsil1/XC125458``.
