...
from . import num_primary_labels as num_birdclef2021_primary_labels
...
class BirdCLEF2021BaselineCollator(BirdCLEFCollator):
    def __init__(
        self,
        ...
        super().__init__(
            ...
            num_primary_labels=num_birdclef2021_primary_labels,
            alpha=alpha,
        )
