...
class GANTrainer(BaseTrainer):
    ...
    @classmethod
    def build_from_config(cls, config: DictConfig) -> "GANTrainer":
        """Instantiate Trainer from config.

        Args:
            config (DictConfig): Config to instantiate trainer.

        Returns:
            GANTrainer: Built trainer.
        ...
        if hasattr(config.train, "clip_gradient"):
            ...
            discriminator_grad_clipper = None
